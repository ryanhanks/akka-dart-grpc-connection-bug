...
class HelloRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HelloRequest', createEmptyInstance: create)
    ..aOS(1, 'name')
...
class HelloReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HelloReply', createEmptyInstance: create)
    ..aOS(1, 'message')
    ..hasRequiredFields = false
  ;
