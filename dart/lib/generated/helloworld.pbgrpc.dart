...
class GreeterServiceClient extends $grpc.Client {
  ...
  static final _$sayHelloToAll =
      $grpc.ClientMethod<$0.HelloRequest, $0.HelloReply>(
          '/GreeterService/SayHelloToAll',
          ($0.HelloRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.HelloReply.fromBuffer(value));

  GreeterServiceClient($grpc.ClientChannel channel, {$grpc.CallOptions options})
  ...
  $grpc.ResponseStream<$0.HelloReply> sayHelloToAll(
      $async.Stream<$0.HelloRequest> request,
      {$grpc.CallOptions options}) {
    final call = $createCall(_$sayHelloToAll, request, options: options);
...
abstract class GreeterServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.HelloReply> sayHelloToAll(
